...
def label_color(index):
    ...
    if index == 'sar1' or index == 'sar2' or index == 'sar3' or index == 'sar8' or index == 'sar9':
        ...
        colors = [
            0, 0, 255,      # label 0 的色彩      # blue ---water
            0, 255, 0,      # label 1 的色彩      # green --- trees
            255, 0, 0,      # label 2 的色彩      # red ---_buildings
            210,180,140,    # label 3 的色彩      # brown --- road/bridge
            255, 255, 255,  # label 4 的色彩      # white ---Unknown
        ]
    return colors
...
def sar_path(index):
    if index == 'sar1':
        ...
        train_path = '/data/dz/data/SAR_small_img/256size/0_slide/SAR4/ImageSets/train4new.txt'
        val_path = '/data/dz/data/SAR_small_img/256size/0_slide/SAR4/ImageSets/val4new.txt'
        ...
        train_path = '/data/dz/data/SAR_small_img/256size/0_slide/SAR6/ImageSets/train6new.txt'
        val_path = '/data/dz/data/SAR_small_img/256size/0_slide/SAR6/ImageSets/val6new.txt'
        ...
        root = '/data/dz/data/SAR_small_img/256size/0_slide/SAR6_union'
        train_path = '/data/dz/data/SAR_small_img/256size/0_slide/SAR6_union/ImageSets/train19.txt'
        val_path = '/data/dz/data/SAR_small_img/256size/0_slide/SAR6_union/ImageSets/val19.txt'
        test_path = '/data/dz/data/SAR_small_img/256size/0_slide/SAR6_union/ImageSets/test19.txt'
    return root,train_path,val_path,test_path

def weight_np(index):
    if index == 'sar1' or index == 'sar2' or index == 'sar3' or index == 'sar4' or index == 'sar5' or index == 'sar8' or index == 'sar9' or index == 'sar10' or index == 'sar11' or index == 'sar19':
