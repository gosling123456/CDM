...
def CRFs(original_image_path, predicted_image_path, CRF_image_path):
    ...
    img = img[:anno_rgb.shape[0], :anno_rgb.shape[1], :]
    print(img.shape, anno_lbl.shape)
...
#    use_2d = True   
    ...
    imwrite(CRF_image_path+'/result.png', MAP.reshape(img.shape))
    print("CRF图像保存在",CRF_image_path,"!")

if __name__ == '__main__':
    index = 'sar5'
    original_image_path, _, _ = get_crfs_path(index)
    predicted_image_path = '/data/dz/diffusion_model/DDPN_seg/cls_model_result/SAR5/train_cssl_t25_b4_10_lr0.00001_bs4_ep700/_5_Rosenheim_color.png'
    CRF_image_path = '/data/dz/diffusion_model/DDPN_seg/CRFs/SAR5/cssl_block4_10'
    if CRF_image_path:
